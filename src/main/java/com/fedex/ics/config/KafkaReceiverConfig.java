...
import com.fedex.ics.worker.AutoCommodityClassificationWorker;
...
public class KafkaReceiverConfig {
  ...
  @Autowired
  private AutoCommodityClassificationWorker worker;
  ...
  public Map<String, Object> consumerConfigs() {
      ...
      props.put(ConsumerConfig.GROUP_ID_CONFIG, "autoCommClass");
  ...
  public void receive(@Payload String payload,
   ...
   // logger.info("Auto Commodity Classification Recieved: " + values[0] + " appID: " + appID + " Shipment: " + values[1]);
    if(appID.contains("1005"))
    {
      logger.info("Auto Commodity Classification Processing... TaskID:" + values[0]  + " OID:" + values[1]);
