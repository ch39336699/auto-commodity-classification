...
import com.fedex.ics.jpa.AutoCommodityClassificationRepository;

@Component
public class AutoCommodityClassificationWorker {
  
  private static final Log logger = LogFactory.getLog(AutoCommodityClassificationWorker.class);
  @Autowired
  private AutoCommodityClassificationRepository repo;  
